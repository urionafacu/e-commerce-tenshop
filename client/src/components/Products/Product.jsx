...
import { addCart, addReview, getReviews, getUsers, getOrders, getOrdersxproduct, lsset, getAllCart, getAllProducts } from "../../actions";
...
function Product({ addCart, id, products, searchProducts, onlineUser, reviews, addReview, getReviews, all_users, getUsers, newrev, getOrders, orders, getOrdersxproduct, ordersxproduct, lsset, getAllCart, getAllProducts }) {
