...
import { getOrders, getproductsxorders, finishorder, celarordenPanel, vaciarpanelorders, sendemailorder } from "../../actions";
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <table class="table">
                  ...
                  <tbody>
                    {productsxorder.products && productsxorder.products.map((p, i) => {
                      return (<tr>
                        <th scope="row">{i}</th>
                        <td>{p.name}</td>
